      ...
      <div class="row">
        <div class="col-7">
          ...
          <div>
            ...
            <span class="text-h6">₹3,149</span><span class="q-ml-sm text-grey-6" style="text-decoration: line-through">₹3,699</span>
          ...
          <div class="q-mt-sm">
            ...
            <div class="text-caption q-mt-sm text-grey-8 text-weight-bold">Delivery by: <span class="text-black">Tue, Mar 3</span> </div>
            <div class="text-caption text-subtitle2 text-grey-8 text-weight-bold">Fastest delivery: <span class="text-black">Mon, Mar 2 by 9pm</span> </div>
          </div>
          <div class="q-mt-md">
